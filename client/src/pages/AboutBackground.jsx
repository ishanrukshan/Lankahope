...
import { FaEye, FaBullseye, FaHandshake, FaBalanceScale } from 'react-icons/fa';
import AOS from 'aos';
...
const AboutBackground = () => {
    ...
    const pillars = [
        {
            title: "Vision",
            text: "To be the premier national health research organization, driving evidence-based healthcare policies and innovations for a healthier Sri Lanka.",
            icon: <FaEye size={32} className="text-sl-gold" />,
            color: "border-sl-gold"
        },
        {
            title: "Mission",
            text: "To promote, coordinate, and conduct high-quality health research that addresses national health priorities and contributes to improved health outcomes for all Sri Lankans.",
            icon: <FaBullseye size={32} className="text-sl-maroon" />,
            color: "border-sl-maroon"
        },
        {
            title: "Core Values",
            text: "Excellence in Research, Integrity & Ethics, Collaboration & Partnership, Innovation, Transparency & Accountability.",
            icon: <FaHandshake size={32} className="text-sl-gold" />,
            color: "border-sl-gold"
        },
        {
            title: "Mandate",
            text: "To oversee and coordinate all health research activities in Sri Lanka, ensuring ethical standards, capacity building, and the translation of research into policy and practice.",
            ...
            <section className="py-16 px-4 md:px-12 bg-[#FAFAFA]">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100" className="text-gray-600 leading-relaxed text-lg">
                        LankaHope was established to strengthen the national health research system. 
                        Operating under the Ministry of Health, we serve as the apex body for coordinating, promoting, and conducting health research 
                        that addresses the nation's health priorities and contributes to evidence-based policy making.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div data-aos="fade-right" className="w-full md:w-1/2">
                            ...
                            <h2 className="text-3xl md:text-4xl font-serif mb-6">A Legacy of Excellence</h2>
                            <div className="space-y-4 text-gray-300 leading-relaxed">
                                <p>
                                    Since its inception, LankaHope has been at the forefront of advancing health research in Sri Lanka. 
                                    Our organization has played a pivotal role in addressing national health challenges through 
                        ...
                        <div data-aos="fade-left" data-aos-delay="200" className="w-full md:w-1/2">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg text-center">
                                    <div className="text-4xl font-serif text-sl-gold mb-2">25+</div>
                                    <div className="text-gray-400 text-sm">Years of Service</div>
                                </div>
                                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg text-center">
                                    <div className="text-4xl font-serif text-sl-gold mb-2">500+</div>
                                    <div className="text-gray-400 text-sm">Research Projects</div>
                                </div>
                                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg text-center">
                                    <div className="text-4xl font-serif text-sl-gold mb-2">50+</div>
                                    <div className="text-gray-400 text-sm">Partner Institutions</div>
                                </div>
                                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg text-center">
                                    <div className="text-4xl font-serif text-sl-gold mb-2">9</div>
                                    <div className="text-gray-400 text-sm">Provinces Covered</div>
                                </div>
                            </div>
                        </div>
                    </div>
